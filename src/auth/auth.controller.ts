...
import { KakaoGuestLoginHandlerDocs } from './docs/kakao-guest-login.docs';
...
export class AuthController {
  ...
  @KakaoGuestLoginHandlerDocs
  async kakaoGuestLoginHandler(
    ...
    const token = await this.authService.generateTokenWithGuestUserMigration(
      kakaoUser.id,
      kakaoUser.name,
      STRATEGY_TYPE.KAKAO,
      guestUserId,
